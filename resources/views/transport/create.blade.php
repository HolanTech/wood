...
@section('header')
    ...
    <div class="appHeader bg-primary text-light">
        <div class="left">
            ...
            <div class="pagetitle">Tambah data Transport</div>
            <div class="right"></div>
        </div>
    </div>
@endsection
...
@section('content')
    ...
    <form action="/transport.store" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-1">
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="" class="form-control" name="biaya" placeholder="Biaya" required>
            </div>
        </div>
