...
@section('header')
    <div class="appHeader bg-primary text-light">
        <div class="left">
            ...
            <div class="pagetitle">Kas Yatim</div>
            <div class="right"></div>
        </div>
    </div>
@endsection
@section('content')
                                ...
                                <div class="in">
                                    ...
                                    <div class="">
                                        <div class="btn-group d-flex flex-column">
                                            <a href="/kasyatim.{{ $d->id }}.edit" class="edit btn btn-info btn-sm">
                                            ...
                                            <form action="/kasyatim.{{ $d->id }}.delete" method="post"
    ...
    <div class="fab-button bottom-right" style="margin-bottom: 70px;">
        <a href="/kasyatim.create" class="fab"><ion-icon name="add-outline"></ion-icon></a>
    </div>
@endsection
@push('script')
    <script>
