...
<div class="appHeader bg-primary text-light">
    <div class="left">
        ...
        <div class="pagetitle">Pembelian</div>
        <div class="right"></div>
    </div>
</div>
@section('content')
                                ...
                                <div class="in">
                                    ...
                                    <div class="">
                                        <div class="image-container">
                                            @php
                                                $path = Storage::url('uploads/beli/' . $d->file);
                                            @endphp
                                            @if (empty($d->file))
                                    ...
                                    <div class="">
                                        <div class="btn-group d-flex flex-column">
                                            <a href="/beli.{{ $d->id }}.edit" class="edit btn btn-info btn-sm">
                                            ...
                                            <form action="/beli.{{ $d->id }}.delete" method="post"
    ...
    <div class="fab-button bottom-right" style="margin-bottom: 70px;">
        <a href="/beli.create" class="fab"><ion-icon name="add-outline"></ion-icon></a>
    </div>
    {{-- modal  --}}
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="max-width: max-content; ">
                <div class="modal-header">
                    <h4 class="modal-title" id="vcenter">Pembelian</h4>
...
@push('script')
    <script>
        ...
        function viewFile(data) {
            let url = window.location.origin + '/storage/uploads/beli/' + data;
