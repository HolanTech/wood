...
@section('header')
    <div class="appHeader bg-primary text-light">
        <div class="left">
            ...
            <div class="pagetitle">Tambah PO Masuk</div>
            <div class="right"></div>
        </div>
    </div>
@endsection
...
@section('content')
    ...
    <form action="/po_in.store" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-1">
            ...
            <div class="col-11">
                <input type="text" value="" class="form-control" name="po_in" placeholder="Nomor PO">
            </div>
        </div>
        <div class="row">
            <div class="col-1">
