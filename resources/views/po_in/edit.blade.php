...
@section('header')
    ...
    <div class="appHeader bg-primary text-light">
        <div class="left">
            ...
            <div class="pagetitle">Edit Po Masuk</div>
            <div class="right"></div>
        </div>
    </div>
@endsection
...
@section('content')
    ...
    <form action="/po_in.{{ $po_in->po_in }}.update" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-1">
            ...
            <div class="col-11">
                <input type="text" value="{{ $po_in->po_in }}" class="form-control" name="po_in" placeholder="Nomor PO"
                    readonly>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-11">
                <select type="text" name="customer_id" id="customer_id" class="form-select select2" required>
                    ...
                    @foreach ($customer as $pelanggan)
                        <option {{ $po_in->customer_id == $pelanggan->id ? 'selected' : '' }} value="{{ $pelanggan->id }}">
                            {{ $pelanggan->nama }}
                        </option>
                    @endforeach
                </select>
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="{{ $po_in->order }}" class="form-control" name="order" placeholder="Pesanan"
                    required>
            </div>
        </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="{{ $po_in->qty }}" class="form-control" name="qty"
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="{{ $po_in->harga }}" class="form-control" name="harga"
        ...
        <div class="row">
            ...
            <div class="col-11">
                ...
                <input type="hidden" value="{{ $po_in->file }}" class="form-control" name="old_file">
