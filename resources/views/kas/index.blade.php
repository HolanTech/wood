...
@section('content')
    ...
    <div class="row ">
        ...
        <div class="col-12 mt-0">
            <div class="card m-0">
                @foreach ($data as $d)
                    <a href="/kas.show{{ $d->id }}" style="text-decoration: none">
                            ...
                            <li>
                                <div class="item">
                                    <div class="in">
                                        ...
                                        <div class="col-3"><span class="badge bg-warning text-light">
                                                Rp.{{ number_format($d->credit, 2, ',', '.') }}</span>
                                        </div>
                                    </div>

                                    <div class="">
                                        <div class="btn-group d-flex flex-column">
                                            <a href="/kas.{{ $d->id }}.edit" class="edit btn btn-info btn-sm">
                                            ...
                                            <form action="/kas.{{ $d->id }}.delete" method="post"
