...
@section('header')
    ...
    <div class="appHeader bg-primary text-light">
        <div class="left">
            ...
            <div class="pagetitle">Tambah Project</div>
            <div class="right"></div>
        </div>
    </div>
@endsection
...
@section('content')
    ...
    <form action="/project.store" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="" class="form-control" name="project" placeholder="Nama Project :"
                    required>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="" class="form-control" name="nama_perusahaan"
        ...
        <div class="row">
            <div class="col-1">
                <div class="input-icon mb-3">
                    <span class="input-icon-addon">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-message-code"
                            width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                            fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <path d="M8 9h8" />
            ...
            <div class="col-11">
                <input type="text" value="" class="form-control" name="no_kontrak" placeholder="Nomor Kontrak :">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="" class="form-control" name="status" placeholder="Status :"
                    required>
            </div>
