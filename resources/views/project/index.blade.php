...
@section('content')
                                ...
                                <div class="in">
                                    ...
                                    {{-- <div class="">
                                        <div class="image-container">
                                            @php
                                                $path = Storage::url('uploads/project/' . $d->foto);
                                            @endphp
                                            @if (empty($d->foto))
                                    ...
                                    <div class="col-md-3 col-sm-3 col-lg-3">
                                        <div class="content">
                                            <span>{{ $d->project }}</span><br>
                                            <strong>{{ $d->nama_perusahaan }}</strong><br>
                                            <span>{{ $d->no_kontrak }}</span><br>
                                            {{-- <small class="text-muted">{{ $d->no_hp }}</small> --}}
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-lg-3">
                                        <div class="content">
                                    ...
                                    <div class="">
                                        <div class="btn-group d-flex flex-column">
                                            <a href="/project.{{ $d->id }}.edit" class="edit btn btn-info btn-sm"
                                                nik="">
                                            ...
                                            <form action="/project.{{ $d->id }}.delete" method="post"
    ...
    <div class="fab-button bottom-right" style="margin-bottom: 70px;">
        <a href="/project.create" class="fab"><ion-icon name="add-outline"></ion-icon></a>
    </div>
    </div>
    {{-- modal edit --}}
...
@push('script')
    <script>
        ...
        $(function() {
            // $("#btnTambahproject").click(function() {
            //     $("#modal-inputproject").modal("show")
            // });
