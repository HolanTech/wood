...
@section('content')
    ...
    <form action="/project.{{ $project->id }}.update" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="{{ $project->project }}" class="form-control" name="project"
                    placeholder="Nama Project" readonly>
            </div>
        </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="{{ $project->nama_perusahaan }}" class="form-control" name="nama_perusahaan"
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="{{ $project->no_kontrak }}" class="form-control" name="no_kontrak"
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="{{ $project->keterangan }}" class="form-control" name="keterangan"
