...
@section('header')
    ...
    <div class="appHeader bg-primary text-light">
        <div class="left">
            ...
            <div class="pagetitle">Tambah Karyawan</div>
            <div class="right"></div>
        </div>
    </div>
@endsection
...
@section('content')
    ...
    <form action="/karyawan.store" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="" class="form-control" name="nik" placeholder="NIK" required>
            </div>
        </div>
        <div class="row">
            <div class="col-1">
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="" class="form-control" name="jabatan" placeholder="Jabatan" required>
            </div>
