...
@section('content')
    ...
    <form action="/karyawan.{{ $karyawan->nik }}.update" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="{{ $karyawan->nik }}" class="form-control" name="nik" placeholder="NIK"
                    readonly>
            </div>
        </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-11">
                ...
                <input type="hidden" value="{{ $karyawan->foto }}" class="form-control" name="old_foto">
                <input type="hidden" value="{{ $karyawan->password }}" class="form-control" name="password">
