                                ...
                                <div class="in">
                                    ...
                                    <div class="">
                                        <div class="image-container">
                                            @php
                                                $path = Storage::url('uploads/qc/' . $d->file);
                                            @endphp
                                            @if (empty($d->file))
                                    ...
                                    <div class="col-md-3 col-sm-3 col-lg-3">
                                        ...
                                        <div class="content">
                                            ...
                                            <strong>{{ $d->po_out_id }}</strong><br>
                                            <strong>{{ $d->po_in_id }}</strong><br>
                                            <span>{{ $d->expedisi_nama }}</span><br>
                                            <span>{{ $d->customer_nama }}</span><br>
                                    ...
                                    <div class="">
                                        <div class="btn-group d-flex flex-column">
                                            <a href="/qc.{{ $d->id }}.edit" class="edit btn btn-info btn-sm">
                                            ...
                                            <form action="/qc.{{ $d->id }}.delete" method="post"
...
@push('script')
    <script>
        ...
        function viewFile(data) {
            let url = window.location.origin + '/storage/uploads/qc/' + data;
