...
@section('header')
    ...
    <div class="appHeader bg-primary text-light">
        <div class="left">
            ...
            <div class="pagetitle">Edit Po Keluar</div>
            <div class="right"></div>
        </div>
    </div>
@endsection
...
@section('content')
    ...
    <form action="/po_out.{{ $po_out->po_out }}.update" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-1">
            ...
            <div class="col-11">
                <input type="text" value="{{ $po_out->po_out }}" class="form-control" name="po_out"
            ...
            <div class="col-11">
                <select type="text" name="pengrajin_id" id="pengrajin_id" class="form-select select2" required>
                    ...
                    @foreach ($pengrajin as $pengrajin)
                        <option {{ $po_out->pengrajin_id == $pengrajin->id ? 'selected' : '' }}
                            value="{{ $pengrajin->id }}">
                            {{ $pengrajin->nama }}
                        </option>
                    @endforeach
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="{{ $po_out->order }}" class="form-control" name="order" placeholder="Pesanan"
                    required>
            </div>
        </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="{{ $po_out->qty }}" class="form-control" name="qty"
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="{{ $po_out->harga }}" class="form-control" name="harga"
        ...
        <div class="row">
            ...
            <div class="col-11">
                ...
                <input type="hidden" value="{{ $po_out->file }}" class="form-control" name="old_file">
