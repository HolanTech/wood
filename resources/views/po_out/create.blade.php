...
@section('header')
    <div class="appHeader bg-primary text-light">
        <div class="left">
            ...
            <div class="pagetitle">Tambah PO Keluar</div>
            <div class="right"></div>
        </div>
    </div>
@endsection
...
@section('content')
    ...
    <form action="/po_out.store" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-1">
            ...
            <div class="col-11">
                <input type="text" value="" class="form-control" name="po_out" placeholder="Nomor PO">
            </div>
        </div>
        <div class="row">
            <div class="col-1">
            ...
            <div class="col-11">
                <select type="text" name="pengrajin_id" id="pengrajin_id" class="form-select select2" required>
                    ...
                    @foreach ($pengrajin as $d)
                        <option {{ request('id') == $d->id ? 'selected' : '' }} value="{{ $d->id }}">
                            {{ $d->nama }}
                        </option>
                    @endforeach
                </select>
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="" class="form-control" name="order" placeholder="Pesanan" required>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="" class="form-control" name="harga" placeholder="Harga Total"
                    required>
            </div>
        </div>
        <div class="row">
