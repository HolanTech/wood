...
@section('header')
    ...
    <div class="appHeader bg-primary text-light">
        <div class="left">
            ...
            <div class="pagetitle">Edit PKS</div>
            <div class="right"></div>
        </div>
    </div>
@endsection
...
@section('content')
    ...
    <form action="/pks.{{ $pks->id }}.update" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-1">
            ...
            <div class="col-11">
                <input type="text" value="{{ $pks->no_pks }}" class="form-control" name="no_pks"
                    placeholder="Nomor PKS" readonly>
            </div>
        </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="{{ $pks->nama }}" class="form-control" name="nama" placeholder="Nama PKS"
                    required>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-11">
                ...
                <input type="hidden" value="{{ $pks->file }}" class="form-control" name="old_file">
