...
@section('header')
    ...
    <div class="appHeader bg-primary text-light">
        <div class="left">
            ...
            <div class="pagetitle">Edit Expedisi</div>
            <div class="right"></div>
        </div>
    </div>
@endsection
...
@section('content')
    ...
    <form action="/expedisi.{{ $expedisi->id }}.update" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-1">
            ...
            <div class="col-11">
                <input type="text" value="{{ $expedisi->nama }}" class="form-control" name="nama"
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="{{ $expedisi->email }}" class="form-control" name="email"
                    placeholder="E-mail">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="{{ $expedisi->no_hp }}" class="form-control" name="no_hp"
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="{{ $expedisi->kendaraan }}" class="form-control" name="kendaraan"
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="{{ $expedisi->alamat }}" class="form-control" name="alamat"
        ...
        <div class="row">
            ...
            <div class="col-11">
                ...
                <input type="hidden" value="{{ $expedisi->foto }}" class="form-control" name="old_foto">
