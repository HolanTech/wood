...
<div class="appHeader bg-primary text-light">
    <div class="left">
        ...
        <div class="pagetitle">Expedisi</div>
        <div class="right"></div>
    </div>
</div>
@section('content')
                                ...
                                <div class="in">
                                    ...
                                    <div class="">
                                        <div class="image-container">
                                            @php
                                                $path = Storage::url('uploads/expedisi/' . $d->foto);
                                            @endphp
                                            @if (empty($d->foto))
                                    ...
                                    <div class="">
                                        <div class="btn-group d-flex flex-column">
                                            <a href="/expedisi.{{ $d->id }}.edit" class="edit btn btn-info btn-sm"
                                                nik="">
                                            ...
                                            <form action="/expedisi.{{ $d->id }}.delete" method="post"
    ...
    <div class="fab-button bottom-right" style="margin-bottom: 70px;">
        <a href="/expedisi.create" class="fab"><ion-icon name="add-outline"></ion-icon></a>
    </div>
    </div>
    {{-- modal edit --}}
@endsection
