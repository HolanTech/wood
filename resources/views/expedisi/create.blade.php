...
@section('header')
    ...
    <div class="appHeader bg-primary text-light">
        <div class="left">
            ...
            <div class="pagetitle">Tambah Expedisi</div>
            <div class="right"></div>
        </div>
    </div>
@endsection
...
@section('content')
    ...
    <form action="/expedisi.store" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="" class="form-control" name="nama" placeholder="Nama Lengkap"
                    required>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="" class="form-control" name="no_hp" placeholder="Nomor Handphone"
                    required>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="" class="form-control" name="kendaraan" placeholder="Jenis Kendaraan"
                    required>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="" class="form-control" name="alamat" placeholder="Alamat" required>
            </div>
