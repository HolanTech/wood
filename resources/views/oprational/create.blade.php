...
@section('header')
    ...
    <div class="appHeader bg-primary text-light">
        <div class="left">
            ...
            <div class="pagetitle">Tambah Oprational</div>
            <div class="right"></div>
        </div>
    </div>
@endsection
...
@section('content')
    <div class="row" style="margin-top:70px;">
        <div class="col">
            <form action="/oprational.store" method="POST" id="frmoprational">
                @csrf
                ...
                <div class="form-group">
                    <input type="text" name="po_id" id="po_id" placeholder="Nomor PO">
                </div>
                <div class="form-group">
