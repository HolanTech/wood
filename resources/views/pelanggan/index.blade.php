...
<div class="appHeader bg-primary text-light">
    <div class="left">
        ...
        <div class="pagetitle">Pelanggan</div>
        <div class="right"></div>
    </div>
</div>
@section('content')
                                ...
                                <div class="in">
                                    ...
                                    <div class="">
                                        <div class="image-container">
                                            @php
                                                $path = Storage::url('uploads/pelanggan/' . $d->foto);
                                            @endphp
                                            @if (empty($d->foto))
                                    ...
                                    <div class="">
                                        <div class="btn-group d-flex flex-column">
                                            <a href="/pelanggan.{{ $d->id }}.edit" class="edit btn btn-info btn-sm"
                                                nik="">
                                            ...
                                            <form action="/pelanggan.{{ $d->id }}.delete" method="post"
    ...
    <div class="fab-button bottom-right" style="margin-bottom: 70px;">
        <a href="/pelanggan.create" class="fab"><ion-icon name="add-outline"></ion-icon></a>
    </div>
