...
@section('header')
    ...
    <div class="appHeader bg-primary text-light">
        <div class="left">
            ...
            <div class="pagetitle">Edit Pelanggan</div>
            <div class="right"></div>
        </div>
    </div>
@endsection
...
@section('content')
    ...
    <form action="/pelanggan.{{ $pelanggan->id }}.update" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-11">
                <select type="text" name="badan_hukum" id="badan_hukum" class="form-select select2" required>
                    <option value="0" {{ $pelanggan->badan_hukum == 0 ? 'selected' : '' }}>Perusahaan</option>
                    <option value="1" {{ $pelanggan->badan_hukum == 1 ? 'selected' : '' }}>Perorangan</option>
                </select>
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="{{ $pelanggan->nama }}" class="form-control" name="nama"
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="{{ $pelanggan->email }}" class="form-control" name="email"
                    placeholder="E-mail">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="{{ $pelanggan->no_hp }}" class="form-control" name="no_hp"
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="{{ $pelanggan->alamat }}" class="form-control" name="alamat"
        ...
        <div class="row">
            ...
            <div class="col-11">
                ...
                <input type="hidden" value="{{ $pelanggan->foto }}" class="form-control" name="old_foto">
